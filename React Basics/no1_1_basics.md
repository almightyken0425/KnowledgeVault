...
> [!NOTE]
> **核心概念：抽象化 Abstraction 與 Node.js 的角色**
...
> **關鍵區別**
>
> 一個 Application **扮演**伺服器的角色，是因為它透過**網路**提供服務；如果它不這麼做，它就是一個獨立的或客戶端的 Application。
...
> [!NOTE]
> **核心公式 Node.js = V8 引擎 + 一套全新的 OS API**
> 
