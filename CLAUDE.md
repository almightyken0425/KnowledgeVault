...
純文件庫，以 Markdown 撰寫各領域技術知識文章，供個人學習與參考。無程式碼、無 build 流程。
...
所有文件遵循 `no[編號]_[主題].md` 格式。主編號代表大主題序列，副編號代表該主題下的細分節次。例如 `no1_1_genesis_protocol_code.md` 為第一大主題的第一小節，`no2_1_identity_and_address.md` 為第二大主題的第一小節。

新增文件時應延續現有編號序列，確保閱讀順序清晰。

---

## 撰寫規範

所有文件依循 tutorial_writing skill 的撰寫政策：由下而上建構知識、資料溯源追蹤、多視角敘事、對比式學習。
