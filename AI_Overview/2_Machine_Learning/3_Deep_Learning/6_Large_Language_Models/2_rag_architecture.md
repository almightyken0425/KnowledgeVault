...
- **一本正經胡說八道 Hallucinations:** AI 不懂也會裝懂。
    - **RAG:** 強制 AI 只能根據檢索到的資料回答，有憑有據。
- **知識過期 Knowledge Cutoff:** GPT-4 訓練資料只到 2023 年。
    - **RAG:** 只要更新外部資料庫，AI 就能讀到今天的頭條新聞。
- **私有資料 Private Data:** 企業內部的機密文件不可能拿給 OpenAI 訓練。
    - **RAG:** 資料庫建在本地，AI 只是幫忙閱讀 and 總結，資料不需外流。
