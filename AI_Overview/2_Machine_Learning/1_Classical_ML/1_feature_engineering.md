...
1.  **獨熱編碼 One-Hot Encoding:** 將類別標籤 蘋果 香蕉 轉為 0 1 向量。
2.  **標準化 Normalization:** 將身高跟體重縮放到 0 到 1 之間，避免單位影響計算。
3.  **降維 Dimensionality Reduction:** 使用 PCA 等技術去除不重要的雜訊特徵。
