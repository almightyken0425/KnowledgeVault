...
description: Comprehensive documentation guidelines including both Project Specifications and Technical Knowledge/Tutorials.
---

# Documentation Writing Skills

此技能包含兩大類的撰寫規範，請根據您當前撰寫的文件類型選擇對應的規範。

- **規格撰寫規範:** 適用於專案規格書、畫面設計、功能定義。
  - **重要:** 此類文件嚴格禁止使用編號與括號。
- **技術知識文件撰寫政策:** 適用於區塊鏈協議解析、底層技術教學、技術白皮書。
