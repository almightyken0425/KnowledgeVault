...
根據 `4. MVP 範圍定義.md` 和 `6. 檔案結構計劃.md`，我們至少需要為以下 MVP 範圍內的畫面定義詳細規格（包含 UI 佈局、元件、互動流程、資料來源、錯誤處理等）：
...
- **5.2. 首頁 (HomeScreen)** (已建立檔案 `5.2. 首頁畫面規格.md`)
    - UI 佈局 (控制列、摘要視圖、列表視圖)
...
- **5.7. 設定 - 類別編輯器 (CategoryEditorScreen)**
