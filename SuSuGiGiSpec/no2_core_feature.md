...
- **首次登入流程:**
    ...
    - **查找雲端資料:** 檢查 Firestore 是否存在該 `UserId` 的資料。
...
## AI 分析整合 (Future Feature) - _[付費功能]_
...
### 定期交易 (Recurring Transactions) - _[付費功能]_
...
- **付費版 (Premium Tier):**
    ...
    - **多幣別功能:** 完整的多幣別帳戶、跨幣別轉帳、手動匯率管理。
        
    - **自動化:** 完整的定期交易 (`Schedules`) 功能。
 
    - **進階報表與資料:**
        
        - (未來) 專屬的詳細報表頁面。
        - 匯出資料 (`.csv`, `.db`) 功能 — Premium 專屬且延後至付費版本釋出。
